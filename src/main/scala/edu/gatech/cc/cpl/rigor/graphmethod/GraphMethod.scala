...
//  def graph_sub_methods: ??? = ??? // UniformGraph / ColorGraph
//  def graph_seed_frame_weight: ??? = ??? // UniformGraph / ColorGraph
//  def graph_unary_exp_scale: ??? = ??? // ColorGraph
//  def graph_pairwise_contr_weight: ??? = ??? // PairwiseWeights
//  def graph_pairwise_potts_weight: ??? = ??? // PairwiseWeights
//  def graph_pairwise_sigma: ??? = ??? // PairwiseWeights
  //  def seed_mapping_idx: ??? = ??? // Submethod arg
